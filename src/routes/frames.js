...
router.post('/add',[auth,isTA],async(req,res,next)=>{
    ...
    const {title,frameID,frameType,lobjID,tags,draggables} = req.body
    ...
    const frame = new Frame({title,frameID,frameType,lobjID,tags,draggables})
...
router.post('/update',[auth,isTA],async(req,res,next)=>{
    ...
    for (item of req.body){
        ...
        const {title,frameID,frameType,lobjID,tags,draggables} = item
        ...
        if (!frame) {
            ...
            await Frame.create({title,frameID,frameType,lobjID,tags,draggables})
